...
export class ObjectEzsignsignatureApi {
     ...
     */
    public ezsignsignatureEditObjectV1(pkiEzsignsignatureID: number, ezsignsignatureEditObjectV1Request: models.EzsignsignatureEditObjectV1Request, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQuery.Promise<
    { response: JQueryXHR; body: models.EzsignsignatureEditObjectV1Response;  },
    { response: JQueryXHR; errorThrown: string }
    > {
        let localVarPath = this.basePath + '/1/object/ezsignsignature/{pkiEzsignsignatureID}'.replace('{' + 'pkiEzsignsignatureID' + '}', encodeURIComponent(String(pkiEzsignsignatureID)));
        ...
        requestOptions.data = JSON.stringify(ezsignsignatureEditObjectV1Request);
        if (headerParams['Content-Type']) {
            requestOptions.contentType = headerParams['Content-Type'];
        }
        ...
        >();
        $.ajax(requestOptions).then(
            (data: models.EzsignsignatureEditObjectV1Response, textStatus: string, jqXHR: JQueryXHR) =>
                dfd.resolve({response: jqXHR, body: data}),
            (xhr: JQueryXHR, textStatus: string, errorThrown: string) =>
                dfd.reject({response: xhr, errorThrown: errorThrown})
        );
     ...
     * @param pkiEzsignsignatureID The unique ID of the Ezsignsignature
     */
    public ezsignsignatureGetObjectGetChildrenV1(pkiEzsignsignatureID: number, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQuery.Promise<
