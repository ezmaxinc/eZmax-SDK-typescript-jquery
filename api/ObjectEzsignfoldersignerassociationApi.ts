...
export class ObjectEzsignfoldersignerassociationApi {
     ...
     * @param pkiEzsignfoldersignerassociationID The unique ID of the Ezsignfoldersignerassociation
     */
    public ezsignfoldersignerassociationGetObjectGetChildrenV1(pkiEzsignfoldersignerassociationID: number, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQuery.Promise<
