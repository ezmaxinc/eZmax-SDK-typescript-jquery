...
export class ObjectEzsigndocumentApi {
     ...
     */
    public ezsigndocumentEditObjectV1(pkiEzsigndocumentID: number, ezsigndocumentEditObjectV1Request: models.EzsigndocumentEditObjectV1Request, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQuery.Promise<
    { response: JQueryXHR; body: models.EzsigndocumentEditObjectV1Response;  },
    { response: JQueryXHR; errorThrown: string }
    > {
        let localVarPath = this.basePath + '/1/object/ezsigndocument/{pkiEzsigndocumentID}'.replace('{' + 'pkiEzsigndocumentID' + '}', encodeURIComponent(String(pkiEzsigndocumentID)));
        ...
        requestOptions.data = JSON.stringify(ezsigndocumentEditObjectV1Request);
        if (headerParams['Content-Type']) {
            requestOptions.contentType = headerParams['Content-Type'];
        }
        ...
        >();
        $.ajax(requestOptions).then(
            (data: models.EzsigndocumentEditObjectV1Response, textStatus: string, jqXHR: JQueryXHR) =>
                dfd.resolve({response: jqXHR, body: data}),
            (xhr: JQueryXHR, textStatus: string, errorThrown: string) =>
                dfd.reject({response: xhr, errorThrown: errorThrown})
        );
     ...
     * @param pkiEzsigndocumentID The unique ID of the Ezsigndocument
     */
    public ezsigndocumentGetObjectGetChildrenV1(pkiEzsigndocumentID: number, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQuery.Promise<
